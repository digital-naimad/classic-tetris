...
var BoardController = /** @class */ (function () {
    ...
    BoardController.prototype.startGameplay = function () {
        ...
        this.hud.updateScoreCounter(0);
        this.hud.updateLinesCounter(0);
        this.hud.updateLevelCounter(0);
    ...
    */
    ...
    BoardController.prototype.throwTetromino = function () {
        this.tetromino.applyShapeAndRotation(this.nextTetrominoShape, TetrominoRotation.up);
...
/**
 * Contains visuals and controls logic of a single tetrimino
 * @author      dsremski <d.sremski@gmail.com>
 * @version     10.05.2021
 * @copyright   2021 Damian Śremski
 */
...
var HUDController = /** @class */ (function () {
    ...
    */
    HUDController.prototype.updateScoreCounter = function (currentScore) {
        var _this = this;
        /**
    ...
    HUDController.prototype.registerEventsListeners = function () {
        ScoreEventsManager.registerScoreUpdate(this.updateScoreCounter, this);
    };
    ...
    */
    ...
    GameplayState.prototype.startGame = function () {
        ...
        this.hud.startCountDown(function () {
            _this.attachButtonClickListeners();
